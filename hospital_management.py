class Hospital:
    while True:
        ...
        mysql = mysql.connector.connect(host="localhost", user="root", passwd="Momloverjee@0275")
        ...
        mycursor.execute(
            "create table if not exists patient_detail(name varchar(30) primary key,sex varchar(15),age int(3),"
            "address varchar(50),contact varchar(15))")
        mycursor.execute(
            "create table if not exists doctor_details(name varchar(30) primary key,specialisation varchar(40),"
            "age int(2),address varchar(30),contact varchar(15),fees int(10),monthly_salary int(10))")
        mycursor.execute(
            "create table if not exists nurse_details(name varchar(30) primary key,age int(2),address varchar(30),"
            "contact varchar(15),monthly_salary int(10))")
        mycursor.execute(
            "create table if not exists other_workers_details(name varchar(30) primary key,age int(2),address varchar("
            "30),contact varchar(15),monthly_salary int(10))")
                                ...
                                if b == 1:
                                    ...
                                    if c == 1:
                                        ...
                                        for i in row:
                                            b = 0
                                            v = list(i)
                                            k = ["NAME", "SPECIALIZATION", "AGE", "ADDRESS", "CONTACT", "FEES",
                                                 "MONTHLY_SALARY"]
                                            d = dict(zip(k, v))
                                            print(d)
                                        ...
                                        for i in row:
                                            v = list(i)
                                            k = ["NAME", "SPECIALIZATION", "AGE", "ADDRESS", "CONTACT",
                                                 "MONTHLY_SALARY"]
                                            d = dict(zip(k, v))
                                            print(d)
                                        ...
                                        for i in row:
                                            v = list(i)
                                            k = [
                                                "NAME", "SPECIALISATION", "AGE", "ADDRESS", "CONTACT", "MONTHLY_SALARY"
                                            ]
                                            d = dict(zip(k, v))
                                            print(d)
                                    ...
                                    # for nurse details
                                        ...
                                        mycursor.execute(
                                            "insert into nurse_details values('" + name + "','"
                                            + age + "','"
                                            + add + "','"
                                            + cont + "','"
                                            + str(
